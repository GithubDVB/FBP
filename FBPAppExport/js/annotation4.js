...
function loadQuestion(init) {
        ...
        switch (init) {
            case 0:
                ...
                document.getElementById('vraagAnnotation').innerHTML = 'Hoe blij was je denk je om ';
                document.getElementById('Pick1Text').innerHTML = 'Niet blij';
                document.getElementById('Pick2Text').innerHTML = 'Een beetje blij';
                document.getElementById('Pick3Text').innerHTML = 'Blij';
                document.getElementById('Pick4Text').innerHTML = 'Heel erg blij';
                getGraph(1);
                break;
            case 1:
                $("#progressBar").animate({
                ...
                document.getElementById('vraagAnnotation').innerHTML = 'Vergeleken met je vorige antwoord, hoe blij was je om  ';
                document.getElementById('Pick1Text').innerHTML = 'Minder blij';
                document.getElementById('Pick2Text').innerHTML = 'Ongeveer zelfde';
                document.getElementById('Pick3Text').innerHTML = 'Blijer';
