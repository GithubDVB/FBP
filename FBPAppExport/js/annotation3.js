...
function loadQuestion(init) {
        ...
        switch (init) {
            case 0:
                ...
                document.getElementById('vraagAnnotation').innerHTML = 'Hoeveel pijn had je in je voeten/benen om ';
                document.getElementById('Pick1Text').innerHTML = 'Geen pijn';
                document.getElementById('Pick2Text').innerHTML = 'Een beetje pijn';
                document.getElementById('Pick3Text').innerHTML = 'Redelijk wat pijn';
                document.getElementById('Pick4Text').innerHTML = 'Heel veel pijn';
                getGraph(1);
                break;
            case 1:
                $("#progressBar").animate({
                ...
                document.getElementById('vraagAnnotation').innerHTML = 'Vergeleken met je vorige antwoord, hoeveel pijn had je om  ';
                document.getElementById('Pick1Text').innerHTML = 'Minder pijn';
                document.getElementById('Pick2Text').innerHTML = 'Ongeveer zelfde';
                document.getElementById('Pick3Text').innerHTML = 'Meer pijn';
