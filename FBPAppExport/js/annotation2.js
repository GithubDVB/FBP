...
function loadQuestion(init) {
        ...
        switch (init) {
            case 0:
                ...
                document.getElementById('vraagAnnotation').innerHTML = 'Hoeveel stress had je denk je om ';
                document.getElementById('Pick1Text').innerHTML = 'Geen stress';
                document.getElementById('Pick2Text').innerHTML = 'Een beetje stress';
                document.getElementById('Pick3Text').innerHTML = 'Wel wat stress';
                document.getElementById('Pick4Text').innerHTML = 'Veel stress';
                getGraph(1);
                break;
            case 1:
                $("#progressBar").animate({
                ...
                document.getElementById('vraagAnnotation').innerHTML = 'Vergeleken met je vorige antwoord, hoe gestresst was je om  ';
                document.getElementById('Pick1Text').innerHTML = 'Minder gestresst';
                document.getElementById('Pick2Text').innerHTML = 'Ongeveer zelfde';
                document.getElementById('Pick3Text').innerHTML = 'Meer gestresst';
